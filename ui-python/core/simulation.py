...
def PlayPause(p_state, method_type, optimizer_type, idx_image=-1, idx_chain=-1):
    _PlayPause(p_state, ctypes.c_char_p(method_type), ctypes.c_char_p(optimizer_type), ctypes.c_int(idx_image), ctypes.c_int(idx_chain))
