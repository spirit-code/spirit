...
def Image_Read(p_state, filename, fileformat=0, idx_image=-1, idx_chain=-1):
    corelib.WrapFunction(_Image_Read, [p_state, ctypes.c_char_p(filename), fileformat, idx_image, idx_chain])
...
def Image_Write(p_state, filename, fileformat=0, idx_image=-1, idx_chain=-1):
    corelib.WrapFunction(_Image_Write, [p_state, ctypes.c_char_p(filename), fileformat, idx_image, idx_chain])
...
def Image_Append(p_state, filename, iteration=0, fileformat=0, idx_image=-1, idx_chain=-1):
    corelib.WrapFunction(_Image_Append, [p_state, ctypes.c_char_p(filename), iteration, fileformat, idx_image, idx_chain])
...
def Chain_Read(p_state, filename, idx_image=-1, idx_chain=-1):
    corelib.WrapFunction(_Chain_Read, [p_state, ctypes.c_char_p(filename), idx_image, idx_chain])
...
def Chain_Write(p_state, filename, idx_image=-1, idx_chain=-1):
    corelib.WrapFunction(_Chain_Write, [p_state, ctypes.c_char_p(filename), idx_image, idx_chain])
