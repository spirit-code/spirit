...
_Set_GNEB_Climbing_Falling.argtypes    = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool), ctypes.POINTER(ctypes.c_bool), ctypes.c_int, ctypes.c_int]
_Set_GNEB_Climbing_Falling.restype     = None
def Set_GNEB_Climbing_Falling(p_state, climbing, falling, idx_image, idx_chain):
    _Set_GNEB_Climbing_Falling(p_state, ctypes.POINTER(ctypes.c_bool(climbing)), ctypes.POINTER(ctypes.c_bool(falling)), idx_image, idx_chain)
...
### ------------------- Get LLG -------------------
### Get LLG Time Step
_Get_LLG_Time_Step             = _core.Parameters_Get_LLG_Time_Step
...
def Get_LLG_Time_Step(p_state, dt, idx_image, idx_chain):
    _Get_LLG_Time_Step(p_state, ctypes.c_float(dt), idx_image, idx_chain)

### Get LLG Damping
_Get_LLG_Damping             = _core.Parameters_Get_LLG_Damping
...
_Get_GNEB_Spring_Constant             = _core.Parameters_Get_GNEB_Spring_Constant
...
def Get_GNEB_Spring_Constant(p_state, c_spring, idx_image, idx_chain):
    _Get_GNEB_Spring_Constant(p_state, ctypes.c_float(c_spring), idx_image, idx_chain)

### Get GNEB climbing and falling images
_Get_GNEB_Climbing_Falling             = _core.Parameters_Get_GNEB_Climbing_Falling
...
def Get_GNEB_Climbing_Falling(p_state, climbing, falling, idx_image, idx_chain):
