...
def Image_Read(p_state, filename, fileformat=0, idx_image_infile=-1, idx_image_inchain=-1, 
               idx_chain=-1):
...
def Image_Append(p_state, filename, fileformat=0, idx_image=-1, idx_chain=-1):
