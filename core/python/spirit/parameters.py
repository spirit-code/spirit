...
def Set_LLG_N_Iterations(p_state, n_iterations, n_iterations_log, idx_image=-1, idx_chain=-1):
    _Set_LLG_N_Iterations(p_state, ctypes.c_int(n_iterations), n_iterations_log, idx_image, idx_chain)
...
def Set_GNEB_N_Iterations(p_state, n_iterations, n_iterations_log, idx_image=-1, idx_chain=-1):
    _Set_GNEB_N_Iterations(p_state, ctypes.c_int(n_iterations), n_iterations_log, idx_image, idx_chain)
...
_Get_LLG_N_Iterations.argtypes    = [ctypes.c_void_p, ctypes.POINTER( ctypes.c_int ), ctypes.POINTER( ctypes.c_int ), ctypes.c_int, ctypes.c_int]
_Get_LLG_N_Iterations.restype     = None
def Get_LLG_N_Iterations(p_state, n_iterations, n_iterations_log, idx_image=-1, idx_chain=-1):
    pnt_int = ctypes.POINTER( ctypes.c_int )
    _n_iterations = pnt_int( n_iterations )
    _n_iterations_log = pnt_int( n_iterations_log )
    _Get_LLG_N_Iterations(p_state, ctypes.c_int(n_iterations), n_iterations_log, idx_image, idx_chain)
    n_iterations = _n_iterations
    n_iterations_log = _n_iterations_log
...
_Get_GNEB_N_Iterations.argtypes    = [ctypes.c_void_p, ctypes.POINTER( ctypes.c_int ), ctypes.POINTER( ctypes.c_int ), ctypes.c_int]
_Get_GNEB_N_Iterations.restype     = None
def Get_GNEB_N_Iterations(p_state, iterations, iterations_log, idx_chain=-1):
    pnt_int = ctypes.POINTER( ctypes.c_int )
    _n_iterations = pnt_int( n_iterations )
    _n_iterations_log = pnt_int( n_iterations_log )
    _Get_GNEB_N_Iterations(p_state, iterations, iterations_log, idx_chain)
    n_iterations = _n_iterations
    n_iterations_log = _n_iterations_log
