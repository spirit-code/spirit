...
_MMF_Set_Output_Folder.argtypes = [
    ctypes.c_void_p,
    ctypes.c_char_p,
    ctypes.c_int,
    ctypes.c_int,
...
_MMF_Set_Output_General.argtypes = [
    ctypes.c_void_p,
    ctypes.c_bool,
    ctypes.c_bool,
    ctypes.c_bool,
...
_MMF_Set_Output_Energy.argtypes = [
    ctypes.c_void_p,
    ctypes.c_bool,
    ctypes.c_bool,
    ctypes.c_bool,
...
_MMF_Set_Output_Configuration.argtypes = [
    ctypes.c_void_p,
    ctypes.c_bool,
    ctypes.c_bool,
    ctypes.c_int,
...
_MMF_Set_N_Iterations.argtypes = [
    ctypes.c_void_p,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
_MMF_Set_N_Modes.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.c_int, ctypes.c_int]
...
_MMF_Set_N_Mode_Follow.argtypes = [
    ctypes.c_void_p,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
_MMF_Get_N_Iterations.argtypes = [
    ctypes.c_void_p,
...
def get_n_modes(p_state, idx_image=-1, idx_chain=-1):
    ...
    return int(
        _MMF_Get_N_Modes(p_state, ctypes.c_int(idx_image), ctypes.c_int(idx_chain))
    )
