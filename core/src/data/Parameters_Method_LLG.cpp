...
namespace Data
{
    Parameters_Method_LLG::Parameters_Method_LLG(std::string output_folder, 
            ...
            int rng_seed, scalar temperature_i, Vector3 temperature_gradient_direction, scalar temperature_gradient_inclination,
        ...
        Parameters_Method_Solver(output_folder, output_file_tag, {output[0], output[1], output[2]}, 
            n_iterations, n_iterations_log, max_walltime_sec, force_convergence, time_step),
