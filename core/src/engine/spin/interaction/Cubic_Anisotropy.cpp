...
Cubic_Anisotropy::Cubic_Anisotropy( Common::Interaction::Owner * hamiltonian, intfield indices, scalarfield magnitudes ) noexcept
...
Cubic_Anisotropy::Cubic_Anisotropy( Common::Interaction::Owner * hamiltonian, const Data::ScalarfieldData & cubic_anisotropy ) noexcept
