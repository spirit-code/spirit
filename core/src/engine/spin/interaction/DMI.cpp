...
DMI::DMI( Common::Interaction::Owner * hamiltonian, pairfield pairs, scalarfield magnitudes, vectorfield normals ) noexcept
...
DMI::DMI( Common::Interaction::Owner * hamiltonian, const Data::VectorPairfieldData & dmi ) noexcept
        : DMI( hamiltonian, dmi.pairs, dmi.magnitudes, dmi.normals )
{
}

DMI::DMI( Common::Interaction::Owner * hamiltonian, scalarfield shell_magnitudes, const int chirality ) noexcept
        : Interaction::Base<DMI>( hamiltonian, scalarfield( 0 ) ),
