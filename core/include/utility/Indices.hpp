...
public:
    ...
    public:
        ...
        [[nodiscard]] constexpr value_type operator[]( difference_type idx ) const noexcept
        {
            return i_ + idx;
        }
        ...
        [[nodiscard]] constexpr friend iterator operator+( iterator const & it, difference_type idx ) noexcept
        {
            return iterator{ it.i_ + idx };
        }

        [[nodiscard]] constexpr friend iterator operator+( difference_type idx, iterator const & it ) noexcept
        {
            return iterator{ it.i_ + idx };
        }
        ...
        [[nodiscard]] friend constexpr difference_type operator-( iterator const & a, iterator const & b ) noexcept
        {
    ...
    [[nodiscard]] constexpr value_type operator[]( size_type idx ) const noexcept
    {
        return beg_ + idx;
    }
