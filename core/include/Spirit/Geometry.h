...
*/
PREFIX void Geometry_Get_Bounds(State *state, float min[3], float max[3], int idx_image=-1, int idx_chain=-1) SUFFIX;
...
*/
PREFIX Bravais_Lattice_Type Geometry_Get_Bravais_Lattice_Type(State *state, int idx_image=-1, int idx_chain=-1) SUFFIX;
...
*/
PREFIX void Geometry_Get_Cell_Bounds(State *state, float min[3], float max[3], int idx_image=-1, int idx_chain=-1) SUFFIX;
...
*/
PREFIX int Geometry_Get_Tetrahedra(State * state, const int **indices_ptr, int n_cell_step=1, int idx_image=-1, int 
idx_chain=-1) SUFFIX;
...
PREFIX int Geometry_Delaunay_Triangulation_2D(unsigned int ** triangles,  float * points, int N) SUFFIX;
PREFIX int Geometry_Delaunay_Triangulation_3D(unsigned int ** tetrahedra, float * points, int N) SUFFIX;
