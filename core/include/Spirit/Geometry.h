...
DLLEXPORT void Geometry_Set_mu_s(State *state, float mu_s, int idx_image=-1, int idx_chain=-1) noexcept;
...
DLLEXPORT int Geometry_Get_Cell_Atoms(State *state, scalar ** atoms, int idx_image=-1, int idx_chain=-1) noexcept;
