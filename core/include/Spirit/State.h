...
/**
 * @struct State
 * @brief The opaque state struct, containing all calculation data.
 *
 * ```
 * +-----------------------------+
 * | State                       |
 ...
 * a @rst{inline} :doc:`config file </core/docs/Input>` @endrst
 * specifying your initial system parameters.
