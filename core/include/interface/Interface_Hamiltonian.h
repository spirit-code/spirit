...
DLLEXPORT void Hamiltonian_Set_STT(State *state, float magnitude, const float * normal, int idx_image=-1, int idx_chain=-1);
DLLEXPORT void Hamiltonian_Set_Temperature(State *state, float T, int idx_image=-1, int idx_chain=-1);
...
DLLEXPORT void Hamiltonian_Get_STT(State *state, float * magnitude, float * normal, int idx_image=-1, int idx_chain=-1);
DLLEXPORT void Hamiltonian_Get_Temperature(State *state, float * T, int idx_image=-1, int idx_chain=-1);
