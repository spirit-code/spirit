...
extern "C" void Parameters_Set_LLG_Log_Steps(State *state, int n_iterations, int idx_image=-1, int idx_chain=-1);
// Set GNEB
...
extern "C" void Parameters_Set_GNEB_Log_Steps(State *state, int log_steps, int idx_image=-1, int idx_chain=-1);
...
extern "C" int Parameters_Get_LLG_Log_Steps(State *state, int idx_image=-1, int idx_chain=-1);
// Set GNEB
...
extern "C" int Parameters_Get_GNEB_Log_Steps(State *state, int idx_image=-1, int idx_chain=-1);
