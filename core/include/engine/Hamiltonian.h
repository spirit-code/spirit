...
namespace Engine
{
	...
	*/
	...
	public:
		...
		{
			// Not Implemented!
			Log(Utility::Log_Level::L_ERROR, Utility::Log_Sender::ALL, std::string("Tried to use Hamiltonian::Effective_Field() of the Hamiltonian base class!"));
		...
		{
			// Not Implemented!
			Log(Utility::Log_Level::L_ERROR, Utility::Log_Sender::ALL, std::string("Tried to use Hamiltonian::Energy() of the Hamiltonian base class!"));
			throw Utility::Exception::Not_Implemented;
			return 0.0;
		}
		...
		{
			Log(Utility::Log_Level::L_ERROR, Utility::Log_Sender::ALL, std::string("Tried to use Hamiltonian::Energy_Array_per_Spin() of the Hamiltonian base class!"));
			throw Utility::Exception::Not_Implemented;
		...
		{
			Log(Utility::Log_Level::L_ERROR, Utility::Log_Sender::ALL, std::string("Tried to use Hamiltonian::Energy_Array() of the Hamiltonian base class!"));
			throw Utility::Exception::Not_Implemented;
