  ...
  namespace __stl {
    ...
    auto __transform_sender_t_() {
      if constexpr (__lacks_transform_sender<_Kernel>) {
        ...
        if constexpr (__valid_m<__tfx_sender_, _Kernel, _Sender, _Env>) {
    ...
    struct __receiver {
      ...
      struct __t {
        ...
        template < //
          ...
          same_as<__t> _Self,
          class... _As>
          requires __valid_m<__set_result_t, _Kernel, _Receiver, _Tag, _As...>
      ...
      struct __t {
        ...
        static auto __new_completion_sigs_type() {
          ...
          if constexpr (sender<_NewSender>) {
            ...
            if constexpr (__valid_m<__pre_completions_t, _NewSender, _NewEnv>) {
              using _Completions =
