...
namespace stdexec {
  ...
  concept __valid_m = requires { typename __meval<_Tp, _Args...>; };

  template <class _Fn, class... _Args>
  concept __minvocable = __valid_m<_Fn::template __f, _Args...>;

  template <template <class...> class _Tp, class... _Args>
  concept __msucceeds = __valid_m<_Tp, _Args...> && __ok<__meval<_Tp, _Args...>>;
  ...
  struct __mtry_catch_q {
    template <class... _Args>
    using __f = __minvoke< __if_c<__valid_m<_Try, _Args...>, __q<_Try>, _Catch>, _Args...>;
  };
