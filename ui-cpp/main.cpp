...
int main(int argc, char ** argv)
{
    ...
    auto cli = lyra::cli_parser()
              ...
              | lyra::opt(chainfile, "initial chain file")["-c"]["--chain"]("The initial chain configuration to use. (Overwrites initial spin configuration)")
              | lyra::opt(quiet)["-q"]["--quiet"]("If spirit should run in quiet mode.")
              | lyra::opt(show_version)["--version"]("Show version information.")
              | lyra::help(show_help);
