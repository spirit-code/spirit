...
bool InputScalar(
    const char * label, scalar * v, scalar step = 0, scalar step_fast = 0, const char * format = "%.3f",
    ImGuiInputTextFlags flags = 0 );
bool InputScalar3( const char * label, scalar v[3], const char * format = "%.3f", ImGuiInputTextFlags flags = 0 );
